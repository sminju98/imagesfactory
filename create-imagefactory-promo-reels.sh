...
# ImageFactory 홍보 릴스 생성 스크립트

echo "🎬 ImageFactory 홍보 릴스 생성"
echo "================================"
echo ""
...
# 테스트 실행
echo ""
echo "🚀 ImageFactory 홍보 릴스 생성 시작..."
echo ""
echo "📝 프로젝트: ImageFactory 홍보 릴스"
echo "🎯 목적: 서비스 소개 및 신규 사용자 유치"
echo ""

node test-reels-api-real.js
